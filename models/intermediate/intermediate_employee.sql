...
SELECT 
  ...
  --CASE WHEN birthDate = 'NULL' THEN TO_DATE('09-99-9999', 'MM-DD-YYYY') ELSE TO_DATE(birthDate, 'MM-DD-YYYY') END AS birthDate,
  --CASE WHEN hireDate = 'NULL' THEN TO_DATE('09-99-9999', 'MM-DD-YYYY') ELSE TO_DATE(hireDate, 'MM-DD-YYYY') END AS hireDate,
  ...
  --CASE WHEN extension = 'NULL' THEN 0 ELSE extension END AS extension,
  CASE WHEN photo = 'NULL' THEN 'None' ELSE photo END AS photo,
  CASE WHEN notes = 'NULL' THEN 'None' ELSE notes END AS notes,
  --CASE WHEN reportsTo = 'NULL' THEN 0 ELSE reportsTo END AS reportsTo,
