...
GROUP BY productname, categoryname, p.categoryid, o.orderid, od.unitprice, quantity, discount, supplierid, QuantityPerUnit, reorderlevel, discontinued, unitcost, orderdate, Sales, Profit, ProfitMargin
